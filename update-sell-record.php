...
<html>
<head>
	<title>MyShop | Update Sell Information</title>
...
<body>
	<div class="wrapper">
		...
		<div class="content_wrapper">
			...
			<div class="left">
				<div class="middle">
					<form action="update-sale-record-db.php" method="post">
						<center><label style="color: white;"><h1>My Shop | Update Sell Information</h1></label></center>
						...
						<input type="submit" name="update_sell_info" value="Update Sell Information">
					</form>
				</div>
			</div>
		</div>
